...
public class PurchasableEnchantSeitiTool extends SeitiTool implements IPurchasableItem {
     ...
     */
    public PurchasableEnchantSeitiTool(TextComponent displayName, Material material, String internalName, int customModelData,ToolType toolType, int price) {
        super(displayName, material, internalName, customModelData,toolType);
        this.price = price;
    }
}
