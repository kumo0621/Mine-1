...
public enum SeitiItems {
    ...
    COAL(new PurchasableSeitiItem(Component.text("燃料"), Material.CHARCOAL, "CHARCOAL", 0, 1)),
    ...
    SHEARS(new PurchasableSeitiItem(Component.text("§fハサミ"), Material.SHEARS, "SHEARS", 0, 50)),
    TNT(new TNTSummoner()),
